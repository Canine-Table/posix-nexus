...
\begin{NxSBox}[][Architecture in C]
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{System Programming} How C is used for writing operating systems, compilers, and device drivers.
		\nxTopicD{Embedded Systems} C’s efficiency makes it a preferred choice for embedded development, from microcontrollers to IoT devices.
		\nxTopicD{Performance Considerations} Architectural decisions that impact efficiency, such as cache usage, memory layout, and optimization techniques.
	\end{NxIDBoxL}
\end{NxSBox}
