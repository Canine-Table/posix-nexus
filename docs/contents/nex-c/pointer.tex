...
\begin{NxSBox}[][Pointers and Memory Management]
	\begin{NxIDBox}
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{ssec:Pointer Basics}{Pointer Basics} Understanding how pointers work and why they are essential in C.
		\nxTopicD{ssec:Dynamic Allocation}{Dynamic Allocation} Managing memory manually using `malloc()`, `free()`, and related functions.
		\nxTopicD{ssec:Pointer Arithmetic}{Pointer Arithmetic} Performing arithmetic on pointers for efficient data processing.
	\end{NxIDBoxL}
\end{NxSBox}
