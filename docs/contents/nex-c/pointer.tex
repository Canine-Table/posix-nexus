...
\begin{NxSBox}[][Pointers and Memory Management]
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{Pointer Basics} Understanding how pointers work and why they are essential in C.
		\nxTopicD{Dynamic Allocation} Managing memory manually using `malloc()`, `free()`, and related functions.
		\nxTopicD{Pointer Arithmetic} Performing arithmetic on pointers for efficient data processing.
	\end{NxIDBoxL}
\end{NxSBox}
