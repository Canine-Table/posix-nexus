...
\begin{NxSBox}[][Optimization in C]
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{ssec:Memory Optimization}{Memory Optimization} Using pointers, arrays, and dynamic memory allocation to minimize memory footprint.
		\nxTopicD{ssec:Performance Techniques}{Performance Techniques} Leveraging compiler optimizations, loop unrolling, and inline functions for faster execution.
		\nxTopicD{ssec:Low-Level Tuning}{Low-Level Tuning} Understanding system calls, cache performance, and assembly optimizations for maximum efficiency.
	\end{NxIDBoxL}
\end{NxSBox}
