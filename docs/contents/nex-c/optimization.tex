...
\begin{NxSBox}[][Optimization in C]
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{Memory Optimization} Using pointers, arrays, and dynamic memory allocation to minimize memory footprint.
		\nxTopicD{Performance Techniques} Leveraging compiler optimizations, loop unrolling, and inline functions for faster execution.
		\nxTopicD{Low-Level Tuning} Understanding system calls, cache performance, and assembly optimizations for maximum efficiency.
	\end{NxIDBoxL}
\end{NxSBox}
