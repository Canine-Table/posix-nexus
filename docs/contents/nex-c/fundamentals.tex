...
\begin{NxSBox}[][Fundamentals of C]
	...
	\end{NxIDBox}
	\begin{NxIDBoxL}
		\nxTopicD{ssec:Core Syntax}{Core Syntax} The fundamental building blocks of C—variables, loops, conditionals, and operators.
		\nxTopicD{ssec:Core Syntax and Structure}{Core Syntax and Structure} Variables, loops, conditionals, functions, and fundamental programming constructs in C.
		\nxTopicD{ssec:Memory Management}{Memory Management} How C handles memory using pointers, dynamic allocation, and manual memory control.
	\end{NxIDBoxL}
\end{NxSBox}
