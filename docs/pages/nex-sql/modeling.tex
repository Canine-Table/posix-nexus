...
\begin{tikzpicture}[every node/.style={scale=0.9}]
	...
	\node[/nx/lbl/above={nodeAb}] {APARTMENT}
		node[below=-1mm of nodeAb] {\nxArcBox[]{(a) APARTMENT is\\ID-Dependent\\on BUILDING}}
		node[/nx/lbl/above={nodeBb}] {PRINT}
		node[below=-1mm of nodeBb] {\nxArcBox[]{(b) PRINT is\\ID-Dependent\\on PAINTING}}
		node[/nx/lbl/above={nodeCb}] {EXAM}
		node[below=-1mm of nodeCb] {\nxArcBox[]{(c) EXAM is\\ID-Dependent\\on PATIENT}};

		\begin{scope}[shft/.style={xshift=-2cm}]
			\draw[/nx/crowsfoot={nn}{pp}] ([shft]nodeAa.south east) -- ([shft]nodeAb.north east);
			\draw[/nx/crowsfoot={nn}{pp}] ([shft]nodeBa.south east) -- ([shft]nodeBb.north east);
			\draw[/nx/crowsfoot={nn}{mm}] ([shft]nodeCa.south east) -- ([shft]nodeCb.north east);
	\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[every node/.style={scale=0.9}]
	...
	\node[/nx/lbl/above={nodeAb}] {VEHICLE}
		node[below=-1mm of nodeAb] {\nxArcBox[]{(a) ID-Dependent Entity}}
		node[/nx/lbl/above={nodeAc}] {VEHICLE}
		node[below=-1mm of nodeAc] {\nxArcBox[]{(b) Non-ID-Dependent\\Weak Entity}};

		\begin{scope}[shft/.style={xshift=-2cm}]
			\draw[/nx/crowsfoot={nn}{pp}] (nodeAa) -- ([shft]nodeAb.north east);
			\draw[/nx/crowsfoot={nn}{pp}] (nodeAa) -- ([shft]nodeAc.north east);
\end{scope}
\end{tikzpicture}
\end{center}
