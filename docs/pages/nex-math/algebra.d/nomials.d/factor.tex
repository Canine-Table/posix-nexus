...
\begin{NxLightListBox}[title={Perfect Square Trinomial}]
	\nxEachLabel{ArrowDark}{Secondary}{{4}{5}}{%
		{Definition}/{A trinomial formed by squaring a binomial},%
		{General Form}/{\((a+b)^2 = a^2 + 2ab + b^2\)},%
		{Expansion}/{First term squared, double product of terms, last term squared},%
