...
document.addEventListener('DOMContentLoaded', () => {
	...
	const stk = new NxStack();
	//stk.push(32)
	stk.push(635255)
	console.log(stk.peekLength(), stk.peek());
	stk.push(2185)
	console.log(stk.peekLength(), stk.peek());
	stk.push(891185)
	console.log(stk.peekLength(), stk.peek());
...
[
	...
	for (let i = 1; i <= 99; ++i) {
		ptr = slab.push(i, ptr);
		//console.log(slab.i32[slab.head(ptr)]);
	}

	for (let i = 1; i <= 99; ++i) {
		const tp = slab.top(ptr);
		//const res = slab.i32[tp];
		//console.log(ptr, tp, ' => ', res);
