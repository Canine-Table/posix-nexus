function! s:NxTeXSettings()
	...
	let g:vimtex_compiler_method = BaseName(getenv('G_NEX_TEX_BACKEND'))
	let g:nex_tex_compiler = BaseName(getenv('G_NEX_TEX_COMPILER'))
	let g:vimtex_view_method = BaseName(getenv('G_NEX_TEX_VIEWER'))
	let l:backends = {
	...
	if has_key(l:backends, g:vimtex_compiler_method)
		...
		call CallFunction(l:backends[g:vimtex_compiler_method])
