...
{
	static instances = {};
	static breaks = [ 'sm', 'md', 'lg', 'xl', 'xxl' ];
	static justifies = [ 'evenly', 'between', 'around', 'end', 'start', 'center' ];
	static directions = [ 'left', 'right', 'top', 'bottom' ];
	static locations = [ 'start', 'center', 'end' ];
	static layouts = [ 'row', 'col', 'row-cols', 'offset' ];
...
export class nexRow extends nexLayout
{
	constructor(obj) {
		super();
		obj = Dom.skel(obj, true);
		if (! (obj.container instanceof nexContainer))
		...
		obj.clsSet = 'layout-container-row';
		this.addElement(obj);
	}
