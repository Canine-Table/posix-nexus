...
export class NxStack
{
	constructor(
		...
		const B = this.B = new ArrayBuffer(size << size2);
		...
		console.group("NxStack Constructor");
		console.log(
			"block:", block,
			"\nheader:", header,
			"\nsize:",  size,
			...
			"\ntop:",  i32[S_TOP],
			"\nfreed:",  i32[S_FREED],
			"\nlog2 block:", u8[S_BLOCK2],
			"\nlog2 size:", u8[S_SIZE2],
			"\nlog2 start:", u8[S_START2],
			"\nstart:", i32[S_START]
		);
		console.groupEnd("NxStack Constructor");
	}
}
