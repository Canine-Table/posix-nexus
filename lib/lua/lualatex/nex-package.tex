...
\usepackage[acronym]{glossaries} % Handles glossaries, acronyms, and term definitions with automated referencing
\usepackage[backend=biber,style=ieee]{biblatex} % Manages bibliographies and citations using an external .bib file
