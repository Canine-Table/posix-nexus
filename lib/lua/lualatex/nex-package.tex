...
\usepackage[cache]{minted} % Uses Pygments for syntax highlighting of code
...
\usepackage[
	...
	nonumberlist,
	style=tree
]{glossaries} % Handles glossaries, acronyms, and term definitions with automated referencing
\usepackage[
	abbreviations,
	symbols,
	automake,
...
\usepackage[
	backend=biber,
	style=ieee
]{biblatex} % Manages bibliographies and citations using an external .bib file
