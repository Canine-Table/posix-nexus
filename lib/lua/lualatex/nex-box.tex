...
\NewDocumentEnvironment{NxILBoxT}{mO{}}
{
	\begin{NxILBox}[breakable, halign=center, #2]
		\begin{tabular}{#1}
}{
		\end{tabular}
	\end{NxILBox}
...
\NewDocumentEnvironment{NxIDBoxT}{mO{}}
{
	\begin{NxIDBox}[breakable, halign=center, #2]
		\begin{tabular}{#1}
}{
		\end{tabular}
	\end{NxIDBox}
...
\long\def\nxIDSTopic#1{\nxItemDark{\nxTopic{success.frame}{#1}}}
\long\def\nxILSTopic#1{\nxItemLight{\nxTopic{success.back}{#1}}}
